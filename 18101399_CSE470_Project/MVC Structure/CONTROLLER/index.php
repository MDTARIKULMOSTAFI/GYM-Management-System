...
<html lang="en">
  ...
  <body style="background:url('../VIEW/images/1087587.jpg'); background-size: cover;">
    <div class="container-fluid" style="margin-top:60px;margin-bottom:60px;color:#34495E;">
      <div class="row">
        <div class="col-md-1"></div>
        <div class="col-md-4">
          <div class="card">
            <img src="../VIEW/images/depositphotos_118287756-stock-photo-abstract-blurred-photo-of-fitness.jpg" class="card-img-top">
            <div class="card-body">
              <center>
