...
<html>
 ...
 <div class="jumbotron" style="border-radius:0;background:url('../VIEW/images/cardback.jpg');background-size:cover;height:400px;"></div>
        ...
        <div class="col-md-3">
            <div class="list-group">
                <a href="" class="list-group-item active"
                   >Members</a>
                <a href="../MODEL/trainer_details.php" class="list-group-item">Member details</a>
		       ...
		       <div class="nav-login">
			       <?php
				        if (isset($_SESSION['u_id'])) {
						  echo '<form action="../MODEL/includes/index.php" method="POST">
