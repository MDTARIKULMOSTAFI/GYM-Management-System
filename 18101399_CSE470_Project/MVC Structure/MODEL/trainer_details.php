...
<body>
<div class="jumbotron" style="background: url('../VIEW/images/cardback.jpg') no-repeat;background-size: cover;height: 300px;"></div>	
...
<div class="card">
     <div class="card-body" style="background-color:#3498DB;color:#ffffff;">
         <div class="row">
             <div class="col-md-1">
    <a href="../CONTROLLER/admin-panel.php" class="btn btn-light ">Go Back</a>
             </div>
